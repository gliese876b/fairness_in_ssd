...
This repository contains the primary code for [`the paper`](https://dl.acm.org/doi/10.65109/CZPZ7833) named "Fairness over Equality: Correcting Social Incentives in Asymmetric Sequential Social Dilemmas" and uses Git Submodules to manage key external dependencies: `meltingpot` and `BenchMARL`. The extended version of the paper can be accessed [`here.`](https://arxiv.org/pdf/2602.15407)
